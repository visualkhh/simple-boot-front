...
var template$a = "<section>\n    <h2>${this.title}$</h2>\n    <dl dr-pre>\n        <ul>\n            <li>\n                <dt>OnSimCreate: onSimCreate()</dt>\n                <dd>Sim create just one call</dd>\n            </li>\n        </ul>\n    </dl>\n</section>\n";

var CoreLifecycleTemplateSecthion = (function () {
    function CoreLifecycleTemplateSecthion() {
        this.title = 'core life cycle';
    }
    CoreLifecycleTemplateSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'core-lifecycle-template-secthion',
            template: template$a
        })
    ], CoreLifecycleTemplateSecthion);
    return CoreLifecycleTemplateSecthion;
}());

var template$9 = "<section>\n    <h2>${this.title}$</h2>\n    <dl dr-pre>\n        <ul>\n            <li>\n                <dt>OnChangedRender: onChangedRender()</dt>\n                <dd>change rended in module event</dd>\n            </li>\n            <li>\n                <dt>OnFinish: onFinish()</dt>\n                <dd>Sim create just one call</dd>\n            </li>\n            <li>\n                <dt>OnInit: onInit()</dt>\n                <dd>module load event</dd>\n            </li>\n            <li>\n                <dt>OnDestroy: onDestroy()</dt>\n                <dd>module destroy event</dd>\n            </li>\n            <li>\n                <dt>OnInitedChild: onInitedChild()</dt>\n                <dd>module and child module inited event</dd>\n            </li>\n        </ul>\n    </dl>\n</section>\n";

var FrontLifecycleTemplateSecthion = (function () {
    function FrontLifecycleTemplateSecthion() {
        this.title = 'front life cycle';
    }
    FrontLifecycleTemplateSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'front-lifecycle-template-secthion',
            template: template$9
        })
    ], FrontLifecycleTemplateSecthion);
    return FrontLifecycleTemplateSecthion;
}());
...
var ComponentTemplateSecthion = (function () {
    function ComponentTemplateSecthion() {
        this.title = 'Component';
    }
    ComponentTemplateSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'dom-render-component-template-secthion',
            template: template$7
        })
    ], ComponentTemplateSecthion);
    return ComponentTemplateSecthion;
}());
