...
var CoreLifecycleSecthion = (function () {
    function CoreLifecycleSecthion() {
        this.title = 'core life cycle';
    }
    CoreLifecycleSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'core-lifecycle-secthion',
            template: template$d
        })
    ], CoreLifecycleSecthion);
    return CoreLifecycleSecthion;
}());
...
var CoreFunctionSecthion = (function () {
    function CoreFunctionSecthion() {
        this.title = 'Core engine';
    }
    CoreFunctionSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'core-function-secthion',
            template: template$c
        })
    ], CoreFunctionSecthion);
    return CoreFunctionSecthion;
}());
...
var FrontLifecycleSecthion = (function () {
    function FrontLifecycleSecthion() {
        this.title = 'front life cycle';
    }
    FrontLifecycleSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'front-lifecycle-template-secthion',
            template: template$b
        })
    ], FrontLifecycleSecthion);
    return FrontLifecycleSecthion;
}());
...
var DomrenderFunctionSecthion = (function () {
    function DomrenderFunctionSecthion() {
        this.title = 'View Template engine';
    }
    DomrenderFunctionSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'domrender-function-secthion',
            template: template$a
        })
    ], DomrenderFunctionSecthion);
    return DomrenderFunctionSecthion;
}());
...
var DomrenderComponentTemplateSecthion = (function () {
    function DomrenderComponentTemplateSecthion() {
        this.title = 'Component';
    }
    DomrenderComponentTemplateSecthion = __decorate([
        SimDecorator_7(),
        Component_3({
            selector: 'domrender-component-template-secthion',
            template: template$8
        })
    ], DomrenderComponentTemplateSecthion);
    return DomrenderComponentTemplateSecthion;
}());
