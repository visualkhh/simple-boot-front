    ...
    RawSet.checkPointCreates = function (element, config) {
        ...
        var _loop_1 = function () {
            if (currentNode.nodeType === Node.TEXT_NODE) {
                ...
                console.log('---------->', text.substring(lasterIndex_1, text.length));
...
var FrontComponent = (function () {
    ...
    FrontComponent.prototype.getMarkdown = function () {
    };
...
var FrontOption = (function () {
    ...
    FrontOption.prototype.getMarkdown = function () {
    };
...
var FrontRouter = (function () {
    ...
    FrontRouter.prototype.getMarkdown = function () {
    };
